...
entity Data_Manipulation_FIFO_v1_0_S00_AXIS is
	generic (
...
end Data_Manipulation_FIFO_v1_0_S00_AXIS;

architecture arch_imp of Data_Manipulation_FIFO_v1_0_S00_AXIS is
...
begin
	...
	-- TODO: axis_tready <= '1' when ((mst_exec_state = WRITE_FIFO) and (inputFull = '0')) else '0';

	process(S_AXIS_ACLK)
	begin
	  if (rising_edge (S_AXIS_ACLK)) then
	    if(S_AXIS_ARESETN = '0') then
          -- TODO: make all components' reset inputs low active
	      write_pointer <= 0;
	      writes_done <= '0';
	    else
